...
tldr: I wrote a small game kinda by accident

---

I signed up to run [1 HP Dragon] at a convention in a \<2 hour time window
**with hotseat**. Yeah... Pulling off something good in less than 2 hours, while
your players can join later or leave in the middle requires effort.
...
<aside>
  ...
  and 1. I have a deadline, 2. I need something _accessible_, basic dice-slop so
  everyone can pick it up in 5 seconds.
</aside>
...
> Distribute values from -2 to +2 so that their total equals +1.
>
