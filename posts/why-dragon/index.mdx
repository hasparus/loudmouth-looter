...
<Track
  ...
  max={4}
  style={`--fire: url(${fire})`}
  class="[&_.te-toggle:last-child[aria-checked=true]]:text-accent-700! dark:[&_.te-toggle:last-child[aria-checked=true]]:text-accent-400! [&_.te-toggle:last-child]:before:bg-neu-600! dark:[&_.te-toggle:last-child]:before:bg-neu-400! [&_.te-toggle:last-child[aria-checked=true]]:before:bg-accent-700! dark:[&_.te-toggle:last-child[aria-checked=true]]:before:bg-accent-400! [&_.te-toggle:last-child]:before:size-[0.72em]! [&_.te-toggle:last-child]:before:[transform:none]! [&_.te-toggle:last-child]:before:shadow-none! [&_.te-toggle:last-child]:before:[clip-path:none]! [&_.te-toggle:last-child]:before:[mask:var(--fire)_center/contain_no-repeat]!"
/>
...
{/* ![Hero's Journey](./heros-journey.svg) */}
