...
import RaiseAToastRules from "../../src/rules/why-dragon/raise-a-toast.mdx";
...
I'd usually cut and zoom out immediately after the Dragon falls. Otherwise some
players tend to narrate the parts Transformation, Atonement and Return in an
unstructured way, and we risk skipping over the more shy storytellers.

If there is some kind of immediate danger, like the ceiling falling down, the
nuclear reactor in the heart of the Dragon exploding or a betrayal by an NPC,
please play it. The more Pyre you accumulate during the game, the more
satisfying the Aftermath will be.

Initially, **Aftermath** had the trigger "when the game ends" and asked for
Wishes and Highlights, but playing for twenty minutes after the game technically
ended was awkward.

I extracted the end of session feedback loop into **Raise a Toast**.

<Move illuminated isBaseMove>

### Raise a Toast

<RaiseAToastRules components={props.components} />
...
<aside className="text-sm!">
  I later wrote an Agenda and a few short DM moves.
  <br />
  ~future Piotr
</aside>
...
3. **Tuesday, July 14, 2026** — I ran the game thrice on Bazyliszek and twice
   after it.

   - Changed Jump into Flames to cost **-1 Stat** and reroll both dice instead
     of a selected die. Everybody helping in one roll led to a certain success,
     so I had to either limit the number of people who can help or nerf it. I
     also ran the games for parties of 5 and 6, what happens on conventions, and
     the game needs to handle that.

   - The old reroll let you keep your best die, so bumping `[6][1]` up to a 10+
     cost nothing. You'd never drop below it, and a full table could just grind
     any roll into a full hit. When we reroll both, a fresh 2d6 can miss, so
     there's a risk in rerolling a partial.

   <PrevListManicule />

4. **Friday, July 17, 2026** — Playtest 6. First one as a player.

   - We played online, no whiteboard, just talking thru Discord on phones,
     because my airpods refused to work with the computer. The game is
     accessible enough for conventions, where everybody gets a copy of it.
     Unfortunately, it's not accessible enough for a first-time player to play
     fiction-first with GM calling moves, and without the list of moves on the
     whiteboard.

   - I'm adding "When it drops to -3, Turn to Ash" under Stats, so the character
     sheet itself carries the information. The whole game _is_ the playbook, but
     I'm gonna make this a desperate move for players who'll never open it and
     look just at the character sheet.

   - I'm not sure I'd ever be able to reach the accessibility of games like
     Homebrew World and One Shot World, because a lot of things I _like_ about
     this game, like the descent of raising Pyre and grinding down stats is
     inherently less common and weirder than
     ["If you have more than 1 HP you are ready to go"](https://youtu.be/NmzLeDWk-nA).
     I ran dozens (almost a hundred?) oneshots in the tradition of John Aegard's
     "[Dragonslaying on a Timetable](https://docs.google.com/document/d/17ypjtlHfcwqrU_-x4b7o0e8tZ_dN2TiNLUu48MLAw7Y/edit?hl=en&forcehl=1#heading=h.t8tfotiv4mt1):
     Running Tight 4-Hour Dungeon World One-Shots With Zero Preparation". Every
     oneshot game I run competes for the slot with the aforementioned. Tough
     competition.

   - I noticed WWYFaD delivers some less common types of fun. The DM is
     responsible for increasing the stakes, pushing the Hunters and facilitating
     the fight with the Dragon. They're not responsible for the setting really,
     and as it's meant for oneshots, the players can have a lot of narrative
     freedom. The freeform class allows players to try new things and express
     themselves. I've seen people write in: _Goddess-Sorcerress_ (dragon's
     wife), _Maiden-mutant_ (dragon's daughter), _Tyranosauroid Trickster,
     Qunari, Despotic Pixie Princess_. Today I had a chance to portray a
     _Starfighter Pilot_ to fight the DRAGON: Distributed Reactive Assembly of
     Guardian Ordnance Nodes (i.e.&nbsp;a&nbsp;big mech made from other mechs).
