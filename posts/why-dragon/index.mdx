...
When you _chase your Goal with abandon_, reroll a a die, but **raise Pyre**.
...
<Track
  ...
  max={4}
  style={`--fire: url("${fire}")`}
  class="[&:has(.te-toggle:last-child[aria-checked=true])_.te-toggle]:text-accent-700! dark:[&:has(.te-toggle:last-child[aria-checked=true])_.te-toggle]:text-accent-400! [&_.te-toggle:last-child]:before:bg-neu-400! [&_.te-toggle:last-child:hover]:before:bg-neu-800! [&:has(.te-toggle:last-child[aria-checked=true])_.te-toggle:last-child]:before:bg-accent-700! dark:[&:has(.te-toggle:last-child[aria-checked=true])_.te-toggle:last-child]:before:bg-accent-400! [&_.te-toggle:last-child]:cursor-match [&:has(.te-toggle:last-child:hover)_.te-toggle]:animate-jitter [&_.te-toggle:last-child]:before:size-[0.82em]! [&_.te-toggle:last-child]:before:transform-none! [&_.te-toggle:last-child]:before:shadow-none! [&_.te-toggle:last-child]:before:[clip-path:none]! [&_.te-toggle:last-child]:before:[mask:var(--fire)_center/contain_no-repeat]! dark:[&_.te-toggle:last-child:hover]:before:bg-white!"
/>

<style>
  {
    /* css */ `
    .te-track:has(.te-toggle:last-child:hover) .te-toggle:nth-last-child(2) {
      animation-delay: 33ms;
    }
    .te-track:has(.te-toggle:last-child:hover) .te-toggle:nth-last-child(3) {
      animation-delay: 66ms;
    }
    .te-track:has(.te-toggle:last-child:hover) .te-toggle:nth-last-child(4) {
...
complication. **On a 6-**: mark XP and the DM makes a move.
...
When one of your Stats gets to **-3** or lower, set it to **-3** and **raise
Pyre**. If your Pyre reached **4**, you're **consumed**. Otherwise, you're
downed: you succumb to your wounds for the time being.
...
A downed Hunter goes back up when his companions help him or the smoke clears
and the scene ends.
...
incentivizes the players to play courageously and embrace setbacks.
...
Pyre directly. I'd rather attack their stats. Instead of falling down the
Hunters may say "Hell no, I'm not going down like that!" and trigger **Stoke the
Fire** or **Relinquish their Goal**.
...
- If you'd like to get some more flavor and immersion for the price of lowered
  accessibility, you can say _Build Pyre_ instead of _Mark 1 Pyre_ and _Burn 1
  Body_ instead of _Take -1 Body_.

## Changelog

- **Saturday, July 4, 2026** — After proofreading from Wafergix and Łukasz
  Bartoszewicz
...
- **Sunday, July 5, 2026** — After the first playtest with players who didn't
  read the game before:
  - I felt like the the incentive to Stoke the Fire was not big enough. The game
    turned out well, but I want _less chill & more drama_, so I'm bumping
    ...
    statistically better than rerolling two, but I doesn't _feel_ impactful.
