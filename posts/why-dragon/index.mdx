...
[on my itch.io]: https://hasparus.itch.io/
...
<aside className="xl:-translate-y-19">
...
Lancer", whatever. It creates fictional positioning, and once per session it
lets you **roar**.
...
<aside>
  <q>
    The dragon speaks in your dead brother's voice. It calls you by the
    childhood name nobody knows. Take -1 Soul.
  </q>
</aside>
...
<aside>
  <figure className="zaduma-line-art *:max-w-[414px]">
    ![A man on horseback stabbing a monster with a lance](./horseback.webp)
    <figcaption className="p-0 *:text-xs">
...
Or, inspired by MotW: Boast and gloat, revealing a secret and then Escape.
...
<figure className='*:first:dark:opacity-80'>
